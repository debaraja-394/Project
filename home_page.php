                ...
                <div class="right">
                    ...
                    <div class="messages">
                        ...
                        <div class="message">
                            ...
                            <div class="message-body">
                                <h5>Sunny Leone</h5>
                                <p class="text-bold">Sending lots of love to you! Your support and kindness mean
                                    the world to me ❤️🌟</p>
                            </div>
                        </div>
                        <!------- MESSAGES ------->
                        <div class="message">
                            ...
                            <div class="message-body">
                                <h5>Elvish Yadav</h5>
                                <p class="text-muted">"Grateful for the overwhelming support on my journey through Big
                                    Boss 🙏💫
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="message">
                            ...
                            <div class="message-body">
                                ...
                                <p class="text-muted">If I have seen further, it is by standing on the shoulders of
                                    giants</p>
                            </div>
                        </div>
                    </div>
